                ...
                <div className="row">
                    <div className="col-lg-4">
                        <div className="blog-grid">
                            <div className="blog-img">
                                <a href="#">
                                    <img src="/public/story1.jpg" title="" alt="" style={{width: "100%", height: "20rem"}}/>
                                </a>
                            </div>
                    ...
                    <div className="col-lg-4">
                        <div className="blog-grid">
                            <div className="blog-img">
                                <a href="#">
                                    <img src="/public/story2.jpg" title="" alt="" style={{width: "100%", height: "20rem"}}/>
                                </a>
                            </div>
                            <div className="blog-info my-3">
                                <h2 style={{color: "#F52576"}}>Lorem ipsum dolor sit.</h2>
                    ...
                    <div className="col-lg-4">
                        <div className="blog-grid">
                            <div className="blog-img">
                                <a href="#">
                                    <img src="/public/story3.jpg" title="" alt="" style={{width: "100%", height: "20rem"}}/>
                                </a>
                            </div>
                            <div className="blog-info my-3">
                                <h2 style={{color: "#F52576"}}>Lorem ipsum dolor sit.</h2>
