...
function index() {
  ...
  <h1 className="mb-3" style={{color: "#F52576"}}>What We Do</h1>
    <div className="row align-items-center mb-5">
      ...
      <div className="col-lg-5 px-5 mx-auto order-1 order-lg-2"><img src="/public/what-we-do.jpg" alt="" className="img-fluid mb-4 mb-lg-0"/></div>
    </div>
    <div className="row align-items-center">
      <div className="col-lg-5 px-5 mx-auto"><img src="/public/what-we-do1.jpg" alt="" className="img-fluid mb-4 mb-lg-0"/></div>
